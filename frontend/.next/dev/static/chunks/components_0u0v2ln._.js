...
const Footer = ({ theme, settings })=>{
    const activeTheme = theme?.directory_name || 'theme-a';
    if (activeTheme === 'theme-a') {
    ...
    // Fallback / Theme B default footer
    const siteName = settings?.site_identity?.site_name || 'BestGroup';
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("footer", {
        className: "bg-slate-950 border-t border-slate-900 text-slate-400 py-12 px-6 text-center text-xs",
...
//# sourceMappingURL=components_0u0v2ln._.js.map