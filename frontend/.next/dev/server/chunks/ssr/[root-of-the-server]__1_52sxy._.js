...
async function generateMetadata({ params }) {
    ...
    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPageData"])(slug);
    if (!data) {
        return {
...
async function DynamicSlugPage({ params }) {
    const { slug } = await params;
    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPageData"])(slug);
    if (!data) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1_52sxy._.js.map